...
import 'package:pokedox/pages/pokemonSearch.dart';
import 'package:pokedox/pages/pokemons.dart';
...
class _HomeBarState extends State<HomeBar> {
  ...
  List<TabItem> tabItems = List.of([
    new TabItem(MdiIcons.pokemonGo, "Pokemons", Colors.transparent,
        labelStyle: TextStyle(fontWeight: FontWeight.bold, color: Colors.red)),
    new TabItem(MdiIcons.searchWeb,"Search", Colors.transparent,
        labelStyle: TextStyle(fontWeight: FontWeight.bold, color: Colors.red)),
    new TabItem(MdiIcons.circleEditOutline, "MyZone", Colors.transparent,
        labelStyle: TextStyle(fontWeight: FontWeight.bold, color: Colors.red)),
