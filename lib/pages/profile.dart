...
import 'package:pokedox/pages/userSearch.dart';
import 'package:pokedox/services/auth.dart';
          ...
          child: TextFormField(
            ...
            onSaved: (newValue) {
              setState(() {
                ...
                PokemonDB.updateName(user.uid, newValue);
